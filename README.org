...
En dépit de toutes ces caractéristiques, le lecteur humain peut
déduire la correspondance correcte, souvent par un mécanisme
inconscient de mise en contexte.
