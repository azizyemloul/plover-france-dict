...
Une prise sténotypique consiste à appuyer sur plusieures touches à la
fois et produit un accord représentant une unité de son.


La partie gauche du clavier, actionnée par les doigts de la main
gauche, représente les ~sons de départ~ et est constituée de consonnes
seulement ; les voyelles sont placées sur la partie droite du clavier,
actionnée par les doigts de la main droite ~OEAUI~ ; les signes
parfois étranges (~Łᴎ$DC~) à l'extrême droite représentent les ~sons
finaux~.
...
On appuie avec l'indexe de la main droite sur ~A~, on relâche puis on
fait revenir son indexe à sa position de départ c'est-à-dire au dessus
de la touche ~U~.

On appuie de son majeur de la main gauche sur la touche ~F~ et, toute
en maintenant ~F~ appuyé, de la main droite, on appuie avec son pouce
sur la touche ~E~ et avec son majeur sur la touche ~Ł~.

Les trois touches sont toutes appuyées comme pour un accord de
piano. On relâche les touches toutes à la fois et on fait revenir ses
doigts à leurs positions de repos, sur la rangée du bas. Il se trouve
que pour cette exemple elles y sont déjà.

Ce n'est pas le cas dans notre deuxième exemple, le mot ~RA/PID~ :

Indexe gauche sur ~R~ ; indexe droit sur ~A~ ; on relâche les deux
doigts et on ramène l'indexe droit à se position de départ au dessus
de ~U~.

Le signe ~/~ indique la fin d'un accord.

Le deuxième accord ~PID~ vous l'auriez compris se joue avec
l'annulaire de la main gauche sur ~P~, le majeur de la main droite sur
~I~ et l'auriculaire sur ~D~. On relâche l'accord et on fait revenir
tout ce petit monde à sa place, respectivement ~M~, ~Ł~ et ~C~.


Il est important de veillez à ce mouvement de va et vient après chaque
frappe à la position de départ, c'est une stratégie d'apprentissage
visant à aller le plus rapidement possible, même s'il semble au départ
contradictoire
