...
manière, avec un seul sténogramme.

Résoudre cette problématique s'avère donc incontournable afin de
parvenir à un usage raisonnablement fiable de la sténotypie avec
Plover.
...
- La distinction entre les homophones se fait par le biais de frappes
  supplémentaires suivant une convention qui sera détaillée au titre suivant.
