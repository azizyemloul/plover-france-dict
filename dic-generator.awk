...
## ** Tu
	if ($6 ~ /2s/){
	    ...
	    if ($1 ~/^[^aeiouéàâêïîôh]/){print "\"TU/" $2 "\": \"tu " $1 "\",";}
...
## ** Il, On, Ça
	if ($6 ~ /3s/){
	    ...
	    if ($1 ~/^[^aeiouéàâêïîôh]/){print "\"On/" $2 "\": \"on " $1 "\",";}
	    ...
	    if ($1 ~/^[^aeiouéàâêïîôh]/){print "\"SA/" $2 "\": \"ça " $1 "\",";}

	    if ($1 ~/^[aeiouéàâêïîô]/){print "\"K/SA/" $2 "\": \"que ça " $1 "\",";}
	    if ($1 ~/^[^aeiouéàâêïîôh]/){print "\"K/SA/" $2 "\": \"que ça " $1 "\",";}
...
## ** Nous
	if ($6 ~ /1p/){
	    ...
	    if ($1 ~/^[^aeiouéàâêïîôh]/){print "\"NOU/" $2 "\": \"nous " $1 "\",";}
...
## ** Vous
	if ($6 ~ /2p/){
	    ...
	    if ($1 ~/^[^aeiouéàâêïîôh]/){print "\"F*OU/" $2 "\": \"vous " $1 "\",";}
